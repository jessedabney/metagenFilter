...
def SubSample(i):
    call_with_log("perl /opt/PepPrograms/popoolation_1.2.2/basic-pipeline/subsample-pileup.pl --input {0}_classSeqs_noIndel_remRegs_noSB.mpileup --output {0}_rand{1}.mpileup --target-coverage {2} --max-cov 1000000 --min-qual 20 --fastq-type sanger --method withoutreplace".format(args.prefix, i, args.coverage))
...
def syn_nonsyn_pi(i):
    call_with_log("perl /opt/PepPrograms/popoolation_1.2.2/syn-nonsyn/Syn-nonsyn-at-position.pl --measure pi --pool-size 10000 --fastq-type sanger --min-count 2  --codon-table /opt/PepPrograms/popoolation_1.2.2/syn-nonsyn/codon-table.txt --nonsyn-length-table /opt/PepPrograms/popoolation_1.2.2/syn-nonsyn/nsl_p1.txt --pileup {0}_rand{1}.mpileup --output {0}_rand{1}_syn-nonsyn.pi --snp-output {0}_rand{1}_syn-nonsyn_pi.snps --gtf {2}".format(args.prefix, i, args.gtf))
    print("executing pi syn-nonsyn calculation on subsample {0}".format(i))

def syn_nonsyn_theta(i):
    call_with_log("perl /opt/PepPrograms/popoolation_1.2.2/syn-nonsyn/Syn-nonsyn-at-position.pl --measure theta --pool-size 10000 --fastq-type sanger --min-count 2  --codon-table /opt/PepPrograms/popoolation_1.2.2/syn-nonsyn/codon-table.txt --nonsyn-length-table /opt/PepPrograms/popoolation_1.2.2/syn-nonsyn/nsl_p1.txt --pileup {0}_rand{1}.mpileup --output {0}_rand{1}_syn-nonsyn.theta --snp-output {0}_rand{1}_syn-nonsyn_theta.snps --gtf {2}".format(args.prefix, i, args.gtf))
    print("executing theta syn-nonsyn calculation on subsample {0}".format(i))

def syn_nonsyn_td(i):
    call_with_log("perl /opt/PepPrograms/popoolation_1.2.2/syn-nonsyn/Syn-nonsyn-at-position.pl --measure d --pool-size 10000 --fastq-type sanger --min-count 2  --codon-table /opt/PepPrograms/popoolation_1.2.2/syn-nonsyn/codon-table.txt --nonsyn-length-table /opt/PepPrograms/popoolation_1.2.2/syn-nonsyn/nsl_p1.txt --pileup {0}_rand{1}.mpileup --output {0}_rand{1}_syn-nonsyn.td --snp-output {0}_rand{1}_syn-nonsyn_td.snps --gtf {2}".format(args.prefix, i, args.gtf))
